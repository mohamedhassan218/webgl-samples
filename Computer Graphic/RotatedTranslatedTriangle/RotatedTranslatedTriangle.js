...
{
    //retrieve the canvas:
    var myCan = document.getElementById("RotatedTranslatedTriangle");
    ...
    //we wanna to translate first:
    myMatrix.setRotate(angle, 0.0, 0.0, 1.0);
    myMatrix.translate(Tx, 0.0, 0.0);
