    /**
     * five steps to deal with the buffer:
     * 1- create buffer object gl.createBuffer();
     * 2- bind the buffer object to the attribute variable gl.bindBuffer(gl.ARRAY_BUFFER, bufferObject);
     * 3- write data in the buffer      gl.bufferData(gl.ARRAY_BUFFER, data, usage);
     * 4- assign the buffer object to an attribute variable gl.vertexAttribPointer(location, size, type, normalized, stride, offset);
     * 5- enable assignment of a buffer object to the attribute variable    gl.enableVertexAttribArray(location); 
     */
    var VSHADER_SOURCE = `
    ...
    {
        //retrieve the canvas:
        var myCan = document.getElementById('HelloTriangle');
