...
{
    //retrieve the canvas:
    var myCan = document.getElementById("TranslatedTriangle_Matrix4");
    ...
    //set the translation values to the matrix:
    //setTranslate: method takes the values of translation
